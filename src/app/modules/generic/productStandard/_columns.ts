export const columns = (renderAction: any) => {
    const col = [
        { field: 'id', headerName: 'کد استاندارد', headerClassName: "bg-[#E2E8F0] text-black font-bold", width: 80 },
        { field: 'desc', headerName: 'استاندارد', headerClassName: "bg-[#E2E8F0] text-black font-bold", width: 120 },
