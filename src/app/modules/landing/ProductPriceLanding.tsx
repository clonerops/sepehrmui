...
import { useRetrieveProductsByBrand, useRetrieveProductsByType } from "../product/core/_hooks"
import { columnsProductPrice, columnsProductPriceDashboard } from '../product/helpers/columns'
...
const ProductPriceLanding = () => {
    ...
    const tabs = productsByType?.data?.map((i: any) => {
        ...
        return {
            label: <Box component="div" className='flex gap-x-2'>
                <Box component="img" src={toAbsoulteUrl(image()?.toString())} width={16} />
