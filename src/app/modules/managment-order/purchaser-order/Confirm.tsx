...
const PurchaserOrderConfirm = () => {
    ...
    return (
        <>
            <Typography color="primary" variant="h1" className="pb-8">تایید سفارش خرید</Typography>
                            ...
                            {/* <div className="flex flex-col">
                                <ReusableCard>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <Typography>آیا مایل به تغییر اسم رسمی شرکت فروشنده می باشید؟</Typography>
                                    </div>
                                    <FormikSelect
                                        ...
                                        name="customerOfficialCompanyId" label="اسم رسمی شرکت فروشنده" />
                                    <FormikInput
                                        multiline
                                        minRows={3}
