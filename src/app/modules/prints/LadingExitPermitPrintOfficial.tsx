            ...
            <div ref={printComponentRef} style={{ direction: "rtl", paddingLeft: "8px", paddingRight: "8px" }}>
                {ladingDetailTools?.data?.data?.cargoAnnounce?.order?.invoiceTypeId === 2 &&
                    <>
                        ...
                        <h2 className="text-center font-bold text-xl print:text-lg py-2">مجوز خروج کالا از شرکت مهفام پولاد ویانا</h2>
                    </>
                }
                ...
                <div className="border-[1px] border-b-0 px-4 py-1 border-black">
                    <div className="grid grid-cols-1">
                        <span className="font-bold text-center">لیست اقلام</span>
                    </div>
                </div>
                <table className="!w-full !border-[1px] !border-b-0 !border-black">
                    <thead>
                        <tr>
                            ...
                            <th className="!border-[1px] !border-black text-center ">
                                <span className="!text-[12px]">وزن دقیق(کیلوگرم)</span>
                            </th>
                            <th className="!border-[1px] !border-black text-center ">
                ...
                <div className="flex flex-col mt-4">
                    <p className="text-lg print:text-[14px]">
                        گواهی می گردد اقلام فوق به صورت صحیح و سالم تحویل
                        اینجانب .......................... به کد ملی .......................... به شماره
                        پلاک ......................... گردید. این اقلام تا زمان دریافت رسید و تسویه
                        حساب خریدار به صورت امانت نزد اینجانب می باشد.
                    </p>
                    <p className="flex justify-end items-end font-bold text-lg print:text-[14px]">امضا</p>
                </div>
...
export default LadingExitPermitPrintOfficial;
